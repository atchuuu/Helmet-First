...
Install Git LFS to Download the Weights:
...
To retrain the model, use the following command:python train.py --img 640 --batch 8 --epochs 50 --data helmet.yaml --weights yolov5s.pt --project "../runs/train" --exist-ok
